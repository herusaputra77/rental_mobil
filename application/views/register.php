...
<body>
        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?= base_url('register/tambah')?>">
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      <label for="no_hp" class="d-block">No. HP</label>
                ...
                <center><a href="<?= base_url('auth')?>">Sudah Memiliki Akun</a></center>
              </div>
            </div>
  ...
  <!-- JS Libraies -->
  <script src="<?= base_url()?>assets/stisla/assets/node_modules/jquery-pwstrength/jquery.pwstrength.min.js"></script>
